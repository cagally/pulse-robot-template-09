  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      toast({
        ...
        description: "You'll receive AI reliability insights from Kalybrate."
      });
      setEmail("");
    ...
    <section id="newsletter" className="bg-white py-0">
      <div className="section-container opacity-0 animate-on-scroll">
        <div className="max-w-6xl mx-auto">
          ...
          <h2 className="text-5xl font-display font-bold mb-4 text-left">Get AI Reliability Insights</h2>
          <p className="text-xl text-gray-700 mb-10 text-left">
            Join our newsletter for the latest on AI evaluation best practices, case studies, and industry benchmarks.
          </p>
